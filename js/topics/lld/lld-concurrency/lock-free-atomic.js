...
const topic = makeTopic({
  ...
  tier: "advanced",
  archetype: "pattern",
  oneliner: `CAS instead of mutex.`,
  sections: [
    { title: `Motivation`, body: `<p>CAS instead of mutex.</p>
<p>Without <b>Lock-Free / Atomic</b>, Order Service code accrues ad-hoc fixes — duplicate event handlers, tangled dependencies, and untestable static calls that break under parallel payment load.</p>` },
...
<p>Map the pattern to packages: domain interfaces, infrastructure adapters, and thin HTTP handlers. Unit tests use fakes; integration tests use Testcontainers for Postgres and Kafka.</p>` },
    { title: `Implementation flow`, body: `<p>Typical charge flow with <b>Lock-Free / Atomic</b>:</p>
<ol>
...
<p><b>Use when:</b> the problem shape matches what <b>Lock-Free / Atomic</b> was designed for and simpler code is failing reviews or incidents.</p>` },
    { title: `Production checklist`, body: `<p>Before shipping <b>Lock-Free / Atomic</b> changes to production:</p>
<ul>
...
<p>Interview tip: whiteboard the charge flow, mark where <b>Lock-Free / Atomic</b> applies, and describe one real failure mode and its fix with concrete SQL or config.</p>` }
  ],
  figures: [
...
<text x="200" y="22" text-anchor="middle" fill="#93a1bd" font-size="10" font-family="system-ui">Only token holder may write</text>
  ...
  sim: () => ({
    note: `Explore Lock-Free / Atomic in the payment platform.`,
    toggles: [{ key: "fix", label: "Valid transitions only", kind: "ok", value: false }],
    states: (ctx) => [
      { id: "pending", label: "Pending", x: 200, y: 280, color: C.service },
      { id: "active", label: "Lock-Free / Atomic", x: 500, y: 280, color: C.accent, good: true },
