...
<p>Unlike a generic "best practice" label, it has a specific seat in the payment platform architecture with defined inputs, outputs, and failure modes.</p>` },
    { title: `How it works`, body: `<p>At runtime, components interact in a defined order with configurable timeouts, health checks, and backoff policies. Trace a single <code>POST /v1/charge</code> with <code>X-Request-ID</code> to see where <b>API Gateway</b> applies.</p>
...
<line x1="84" y1="56" x2="108" y2="56" stroke="#5b9dff" stroke-width="1.5" marker-end="url(#fig-api-gateway-arr)"/>
<line x1="210" y1="48" x2="238" y2="35" stroke="#5b9dff" stroke-width="1.5" marker-end="url(#fig-api-gateway-arr)"/>
<line x1="210" y1="64" x2="238" y2="75" stroke="#5b9dff" stroke-width="1.5" marker-end="url(#fig-api-gateway-arr)"/>
</svg>`, caption: `API gateway: auth, rate limit, routing, and aggregation at the edge.` },
    { id: "structure", svg: `<svg viewBox="0 0 480 160" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="API Gateway structure">
<defs><marker id="fig-api-gateway-arr" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#5b9dff"/></marker></defs>
<rect x="30" y="60" width="100" height="40" rx="6" fill="#1a2236" stroke="#9aa7c7" stroke-width="1.5"/>
<text x="80" y="84" text-anchor="middle" fill="#cdd6e8" font-size="11" font-family="system-ui">HTTP Handler</text>
<rect x="170" y="60" width="110" height="40" rx="6" fill="#1a2236" stroke="#5b9dff" stroke-width="1.5"/>
<text x="225" y="74" text-anchor="middle" fill="#cdd6e8" font-size="11" font-family="system-ui">API Gateway</text><text x="225" y="94" text-anchor="middle" fill="#93a1bd" font-size="9" font-family="system-ui">pattern</text>
<rect x="320" y="30" width="90" height="36" rx="6" fill="#1a2236" stroke="#3ddc97" stroke-width="1.5"/>
<text x="365" y="52" text-anchor="middle" fill="#cdd6e8" font-size="11" font-family="system-ui">Ledger DB</text>
<rect x="320" y="95" width="90" height="36" rx="6" fill="#1a2236" stroke="#ffb454" stroke-width="1.5"/>
<text x="365" y="117" text-anchor="middle" fill="#cdd6e8" font-size="11" font-family="system-ui">Event Queue</text>
<line x1="130" y1="80" x2="168" y2="80" stroke="#5b9dff" stroke-width="1.5" marker-end="url(#fig-api-gateway-arr)"/>
<line x1="280" y1="70" x2="318" y2="48" stroke="#5b9dff" stroke-width="1.5" marker-end="url(#fig-api-gateway-arr)"/>
<line x1="280" y1="90" x2="318" y2="113" stroke="#5b9dff" stroke-width="1.5" marker-end="url(#fig-api-gateway-arr)"/>
<text x="240" y="22" text-anchor="middle" fill="#93a1bd" font-size="10" font-family="system-ui">API Gateway — class and integration boundaries</text>
</svg>`, caption: `Structure of the API Gateway pattern — components and data flow in Order Service.` }
  ],
  ...
  template: "topology",
  sim: () => ({
    note: `Explore API Gateway in the payment platform.`,
    toggles: [{ key: "fix", label: "Apply API Gateway", kind: "ok", value: false }],
    nodes: (ctx) => [
    ...
    edges: (ctx) => [
      ...
      { from: "l", to: "q", active: ctx.toggles.fix, label: "API Gateway" },
    ],
    activeEdge: (ctx, t) => ctx.toggles.fix ? { from: "l", to: "q" } : { from: "c", to: "o" },
    status: (ctx) => ({ text: ctx.toggles.fix ? "API Gateway in path" : "pattern absent", cls: ctx.toggles.fix ? "ok" : "warn" }),
  }),
});
