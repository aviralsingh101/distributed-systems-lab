...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Pick storage by access pattern and consistency.</p><p>Neither <b>SQL</b> nor <b>NoSQL Selection</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `SQL — when it wins`, body: `<p>Choose <b>SQL</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `NoSQL Selection — when it wins`, body: `<p>Choose <b>NoSQL Selection</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
