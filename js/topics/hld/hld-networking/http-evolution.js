...
<p><b>Failure isolation:</b> If <b>HTTP/1.1 → HTTP/2 → HTTP/3</b> fails, what still works? Define blast radius and graceful degradation — read-only mode, cached responses, or queue for later.</p>
