...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Reliable streams vs fire-and-forget datagrams.</p><p>Neither <b>TCP</b> nor <b>UDP</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `TCP — when it wins`, body: `<p>Choose <b>TCP</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `UDP — when it wins`, body: `<p>Choose <b>UDP</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
