...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Resource URLs vs client-shaped queries.</p><p>Neither <b>REST</b> nor <b>GraphQL</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
...
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `GraphQL — when it wins`, body: `<p>Choose <b>GraphQL</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
