...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Customer promise vs internal reliability target.</p><p>Neither <b>SLA</b> nor <b>SLO</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `SLA — when it wins`, body: `<p>Choose <b>SLA</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `SLO — when it wins`, body: `<p>Choose <b>SLO</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
