...
const topic = makeTopic({
  ...
  sections: [
    { title: `Framework overview`, body: `<p>Quick capacity math before deep design.</p>
...
<p><b>Back-of-Envelope Estimation</b> is the meta-skill — interviewers grade communication and prioritization, not memorized architectures.</p>` },
...
<p>Ask clarifying questions aloud: mobile vs web? global? strong consistency required? write-heavy? These answers change the diagram.</p>` },
    { title: `When to apply`, body: `<p>Use <b>Back-of-Envelope Estimation</b> at the start of greenfield designs and major refactors — before picking databases or service counts. Skip heavy process for small bugfixes.</p>
