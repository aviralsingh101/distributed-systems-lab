...
const topic = makeTopic({
  ...
  sections: [
    { title: `Functional requirements`, body: `<ul><li>Prefix queries; sub-100ms suggestions.</li><li>Ranking by popularity/recency.</li><li>High QPS, small payload.</li></ul>` },
    { title: `Capacity sketch`, body: `<p>Estimate DAU → peak QPS, storage/day, and fan-out factor. For <b>Search Autocomplete</b>, identify the dominant cost: bandwidth, storage, or compute.</p>
...
<p>Call out read:write ratio; it drives cache vs write-optimized store choice.</p>` },
    { title: `High-level design`, body: `<p>Trie or prefix index in memory (per shard); aggregator merges top-k. Popular queries cached at edge. Ingest pipeline updates counts asynchronously.</p>`, figureAfter: "architecture" },
    { title: `Deep dives`, body: `<p>Pick 2–3 areas interviewers probe: data model, partitioning, caching, consistency. For <b>Search Autocomplete</b>, explain id generation, hot keys, and what fails under 10× load.</p>
