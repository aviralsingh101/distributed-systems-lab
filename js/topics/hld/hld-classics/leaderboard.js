...
const topic = makeTopic({
  ...
  sections: [
    { title: `Functional requirements`, body: `<ul><li>Top-N scores; real-time or near-real-time updates.</li><li>High write rate from game events.</li><li>Tie-breaking; regional boards.</li></ul>` },
    { title: `Capacity sketch`, body: `<p>Estimate DAU → peak QPS, storage/day, and fan-out factor. For <b>Leaderboard</b>, identify the dominant cost: bandwidth, storage, or compute.</p>
...
<p>Call out read:write ratio; it drives cache vs write-optimized store choice.</p>` },
    { title: `High-level design`, body: `<p>Redis sorted sets per board shard; periodic snapshot to DB. Top-N via ZREVRANGE; score updates atomic. Shard by game or region.</p>`, figureAfter: "architecture" },
    { title: `Deep dives`, body: `<p>Pick 2–3 areas interviewers probe: data model, partitioning, caching, consistency. For <b>Leaderboard</b>, explain id generation, hot keys, and what fails under 10× load.</p>
