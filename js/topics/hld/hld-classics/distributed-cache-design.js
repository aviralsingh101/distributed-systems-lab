...
const topic = makeTopic({
  ...
  sections: [
    { title: `Functional requirements`, body: `<p>Consistent hash and eviction.</p><p>Enumerate functional requirements, estimate read/write ratio, and state latency/availability targets before drawing components. Call out MVP vs v2 explicitly.</p>` },
    { title: `Capacity sketch`, body: `<p>Estimate DAU → peak QPS, storage/day, and fan-out factor. For <b>Distributed Cache Design</b>, identify the dominant cost: bandwidth, storage, or compute.</p>
...
<p>Call out read:write ratio; it drives cache vs write-optimized store choice.</p>` },
    ...
    { title: `Deep dives`, body: `<p>Pick 2–3 areas interviewers probe: data model, partitioning, caching, consistency. For <b>Distributed Cache Design</b>, explain id generation, hot keys, and what fails under 10× load.</p>
