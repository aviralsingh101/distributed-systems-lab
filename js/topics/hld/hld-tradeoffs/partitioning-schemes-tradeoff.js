...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Hash, range, or directory routing.</p><p>Neither <b>Option A</b> nor <b>Option B</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `Option A — when it wins`, body: `<p>Choose <b>Option A</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `Option B — when it wins`, body: `<p>Choose <b>Option B</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
