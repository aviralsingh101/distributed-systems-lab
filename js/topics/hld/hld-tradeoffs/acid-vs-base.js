...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Transactional rigor vs eventual relax.</p><p>Neither <b>ACID</b> nor <b>BASE</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `ACID — when it wins`, body: `<p>Choose <b>ACID</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `BASE — when it wins`, body: `<p>Choose <b>BASE</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
