...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Dual pipeline vs stream-only simplification.</p><p>Neither <b>Lambda</b> nor <b>Kappa</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
