...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Periodic jobs vs continuous processing.</p><p>Neither <b>Batch</b> nor <b>Stream</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `Batch — when it wins`, body: `<p>Choose <b>Batch</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `Stream — when it wins`, body: `<p>Choose <b>Stream</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
