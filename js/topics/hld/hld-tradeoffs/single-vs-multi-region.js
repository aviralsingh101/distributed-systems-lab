...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Simplicity vs geo resilience.</p><p>Neither <b>Single</b> nor <b>Multi-Region</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `Single — when it wins`, body: `<p>Choose <b>Single</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `Multi-Region — when it wins`, body: `<p>Choose <b>Multi-Region</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
