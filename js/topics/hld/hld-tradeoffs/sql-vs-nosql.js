...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Schema, joins, and scale tradeoffs.</p><p>Neither <b>SQL</b> nor <b>NoSQL</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
...
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `NoSQL — when it wins`, body: `<p>Choose <b>NoSQL</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
