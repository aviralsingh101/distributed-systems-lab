...
const topic = makeTopic({
  ...
  tier: "essential",
  archetype: "tradeoff",
  oneliner: `Ops burden vs control and cost.`,
  sections: [
    { title: `The decision`, body: `<p>Ops burden vs control and cost.</p><p>Neither <b>Managed</b> nor <b>Self-Hosted</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `Managed — when it wins`, body: `<p>Choose <b>Managed</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `Self-Hosted — when it wins`, body: `<p>Choose <b>Self-Hosted</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
