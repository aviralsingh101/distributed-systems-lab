...
const topic = makeTopic({
  ...
  sections: [
    { title: `The decision`, body: `<p>Who you are vs what you may do.</p><p>Neither <b>AuthN</b> nor <b>AuthZ</b> wins universally — constraints pick the winner. Open with the business constraint (scale, consistency, team, budget), not the technology name.</p>` },
    { title: `AuthN — when it wins`, body: `<p>Choose <b>AuthN</b> when simplicity, strong guarantees, or team familiarity matter more than infinite horizontal scale. Good fit for early stage or strict correctness paths.</p>
<p>List concrete strengths: operability, query flexibility, transaction support, or lower moving parts.</p>` },
    { title: `AuthZ — when it wins`, body: `<p>Choose <b>AuthZ</b> when scale, partition tolerance, or specialized access patterns dominate. Accept higher operational and migration cost.</p>
